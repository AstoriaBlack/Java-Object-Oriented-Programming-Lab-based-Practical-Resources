...
public class WestminsterHealthCentreManager implements HealthCentreManager {
    ...
    public boolean runMenu() {
        ...
        System.out.println("To Deactivate a staff member, press 4");

        System.out.println("To print active staff only, press 5");

        System.out.println("To print staff members by role, press 6");
        ...
        switch(choice){
            ...
            case 5:
                this.printActiveStaffOnly();
                break;

            case 6:
                this.printStaffByRole();
                break;
    ...
    public void deactivateStaffMember() {
        ...
        for (StaffMember staffMember : staffMemberList) {
            if(staffMember.getStaffID().equals(id)) {
                found = staffMember;
                break;
            }
        }
        if(found != null) {
            ...
            else if(found instanceof LaboratoryTechnician) System.out.println("Role: LaboratoryTechnician");
    ...
    public void printStaffByRole() {
        Scanner s = new Scanner(System.in);
        System.out.println("Enter a job role to print");
        String role = s.nextLine();
        boolean isRole = false;

        for (StaffMember staffMember : staffMemberList) {
            if(staffMember.getClass().getSimpleName().equals(role)) {
                System.out.println(staffMember);
                isRole = true;
            }
        }
